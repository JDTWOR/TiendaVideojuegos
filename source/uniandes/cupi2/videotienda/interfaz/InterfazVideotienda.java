...
public class InterfazVideotienda extends JFrame
{
    ...
    public void alquilarPelicula( )
    {
        ...
        try
        {
            videotienda.alquilarPelicula( pelicula, cliente );
            JOptionPane.showMessageDialog( this, "Se alquiló la película \"" + pelicula + "\" exitosamente", "Alquilar Película", JOptionPane.INFORMATION_MESSAGE );
        }
        catch( Exception e )
        {
